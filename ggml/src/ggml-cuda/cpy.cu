...
void ggml_cuda_cpy(ggml_backend_cuda_context & ctx, const ggml_tensor * src0, ggml_tensor * src1) {
    ...
    if (src0->type == src1->type && contiguous_srcs) {
        ...
        ggml_cpy_f32_iq4_nl_cuda
                (src0_ddc, src1_ddc, ne, ne00, ne01, ne02, nb00, nb01, nb02, nb03, ne10, ne11, ne12, nb10, nb11, nb12, nb13, main_stream);
    } else if (src0->type == GGML_TYPE_F32 && src1->type == GGML_TYPE_TURBO3) {
        // TurboQuant KV-cache encode path. KV writes are F32 → turbo3 here;
        // the cache row tensor is allocated with type TURBO3 by llama-kv-cache.
        ggml_cpy_f32_turbo3_cuda
                (src0_ddc, src1_ddc, ne, ne00, ne01, ne02, nb00, nb01, nb02, nb03, ne10, ne11, ne12, nb10, nb11, nb12, nb13, main_stream);
    } else if (src0->type == GGML_TYPE_TURBO3 && src1->type == GGML_TYPE_F32) {
        // Bulk dequant — used by the prefill path and by tests. Flash Attention
        // never goes through here; it dequantises in-tile (Phase 3, fattn-tile.cu).
        ggml_cpy_turbo3_f32_cuda
                (src0_ddc, src1_ddc, ne, ne00, ne01, ne02, nb00, nb01, nb02, nb03, ne10, ne11, ne12, nb10, nb11, nb12, nb13, main_stream);
    } else if (src0->type == GGML_TYPE_F32 && src1->type == GGML_TYPE_TURBO2) {
        ggml_cpy_f32_turbo2_cuda
                (src0_ddc, src1_ddc, ne, ne00, ne01, ne02, nb00, nb01, nb02, nb03, ne10, ne11, ne12, nb10, nb11, nb12, nb13, main_stream);
    } else if (src0->type == GGML_TYPE_TURBO2 && src1->type == GGML_TYPE_F32) {
        ggml_cpy_turbo2_f32_cuda
                (src0_ddc, src1_ddc, ne, ne00, ne01, ne02, nb00, nb01, nb02, nb03, ne10, ne11, ne12, nb10, nb11, nb12, nb13, main_stream);
    } else if (src0->type == GGML_TYPE_TURBO3 && src1->type == GGML_TYPE_F16) {
        // Phase 3 Path A pre-attention dequant: turbo3 cache → F16 scratch
        // immediately before ggml_flash_attn_ext.
        ggml_cpy_turbo3_f16_cuda
                (src0_ddc, src1_ddc, ne, ne00, ne01, ne02, nb00, nb01, nb02, nb03, ne10, ne11, ne12, nb10, nb11, nb12, nb13, main_stream);
    } else if (src0->type == GGML_TYPE_TURBO2 && src1->type == GGML_TYPE_F16) {
        ggml_cpy_turbo2_f16_cuda
                (src0_ddc, src1_ddc, ne, ne00, ne01, ne02, nb00, nb01, nb02, nb03, ne10, ne11, ne12, nb10, nb11, nb12, nb13, main_stream);
